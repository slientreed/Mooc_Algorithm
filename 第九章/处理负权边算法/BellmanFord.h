...
private:
    ...
    // 判断图中是否有负权环；如果还有边没访问过，或者继续加一条边可以使得权值更小，说明还可以进行松弛操作
...
public:
    ...
    BellmanFord(Graph &graph, int s):G(graph){
        ...
        // Bellman-Ford的过程
        // 进行V-1次循环, 每一次循环求出从起点到其余所有点, 最多使用pass步可到达的最短距离，对图中所有点进行V-1次松弛操作；
        ...
        hasNegativeCycle = detectNegativeCycle();   //detectNegativeCycle()判断是否有还能进行松弛操作，还能进行，则有负权边
    }
